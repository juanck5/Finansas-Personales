...
router.get("/movimientos/filter", getMovimientos.filter); //ruta de la api buscar por filtros

router.get("/movimientos/resumenMes/:anio/:mes", getMovimientos.resumenMes); //ruta de la api resumen por mes se usa de esta forma para que siempre se envie el anio y el mes y 
